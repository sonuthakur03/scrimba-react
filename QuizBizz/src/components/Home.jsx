    ...
    <section className="flex-center justify-between ">
      <div className="max-w-[45%] self-start mt-10 flex justify-center flex-col gap-10">
        ...
        <div className="flex items-center gap-4">
          <button className="bg-primary text-xl text-text py-4 px-12 border border-border rounded-md flex-center gap-2">
            Start Quiz <FaLongArrowAltRight className="mt-1" />
          </button>
          <button className=" text-text text-xl font-semibold py-4 px-12 border-2 border-border rounded-md flex-center gap-2">
            Explore Topics
          </button>
        </div>
